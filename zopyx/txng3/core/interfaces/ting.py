...
class ITingIndexSchema(IAttributeIndex):
    ...
    use_stemmer = Bool(
        title=_(u"Stemming"),
        description=_(
            u"Compare words according to their word stems (a kind of similarity search)"),
        default=False,
    ...
    use_stopwords = Bool(
        title=_(u"Stopwords"),
        description=_(
            u"Enable to prvent looking for words like 'and' or 'a' which are unlike to be useful in search queries"),
        required=True,
    ...
    use_normalizer = Bool(
        title=_(u"Normalize"),
        description=_(
            u"Enable to normalize words language specific (e.g. ä -> ae , è -> e)"),
        required=True,
    ...
    ranking = Bool(
        title=_(u"Ranking"),
        description=_(
            u"Enable ranking according to word frequency of documents (selects different storage)"),
        required=True,
    ...
    index_unknown_languages = Bool(
        ...
        description=_(
            u"Assigns unknown languages the first language of the languages selected for this index"),
        required=True,
...
class ITingIndex(ITingIndexSchema, zope.app.catalog.interfaces.ICatalogIndex):
    pass
