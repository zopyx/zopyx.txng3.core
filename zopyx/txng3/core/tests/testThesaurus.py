...
class ThesaurusTests(unittest.TestCase):
    ...
    def testWithExistingLanguagesNoCasefolding(self):
        ...
        self.assertEqual(sorted(T.getTermsFor(u'Abrechnung')), [
                         u'Berechnung', u'Bilanz', u'Faktur', u'Rechnung', u'Schlussrechnung'])
    ...
    def testWithExistingLanguagesWithCaseFolding(self):
        ...
        self.assertEqual(sorted(T.getTermsFor(u'Faktur')), [
                         u'abrechnung', u'berechnung', u'rechnung'])
        self.assertEqual(sorted(T.getTermsFor(u'faktur')), [
                         u'abrechnung', u'berechnung', u'rechnung'])

    def testFilenameConstructor(self):
        filename = os.path.join(os.path.dirname(
            __file__), 'data', 'thesaurus_de.txt')
