...
en1 = """
 If one examines semioticist discourse, one is faced with a choice: either
reject postpatriarchial conceptualist theory or conclude that sexual identity
has intrinsic meaning. If prepatriarchial deconstruction holds, we have to
choose between the neocultural paradigm of narrative and cultural subdialectic
theory.
"""

en2 = """
It could be said that the premise of semanticist narrative suggests that
sexuality is used to oppress minorities, but only if art is distinct from
language; if that is not the case, we can assume that the raison d'etre of the
artist is deconstruction. Lyotard promotes the use of capitalist subcultural
theory to challenge sexist perceptions of society.
"""

en3 = """
Therefore, Baudrillard's model of predialectic situationism implies that the
establishment is intrinsically responsible for capitalism, given that the
premise of the neocultural paradigm of narrative is invalid. Dahmus[1] suggests
that we have to choose between postpatriarchial conceptualist theory and
textual objectivism. 
"""
